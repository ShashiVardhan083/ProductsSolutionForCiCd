...
namespace ProductsSolution.Tests.NUnit.Endpoints
{
    public class DeleteProductEndpointTests
    {
        ...
        public async Task Should_return_not_found()
        {
            ...
            Assert.IsInstanceOf<NotFound<Common.ErrorResponse>>(result);
        }
        ...
        public async Task Should_return_bad_request_when_inactive()
        {
            ...
            Assert.IsInstanceOf<BadRequest<Common.ErrorResponse>>(result);
        }
    }
}